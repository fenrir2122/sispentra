                                                    ...
                                                    foreach ($query->result_array() as $row) {
                                                        ...
                                                        <tr align="center">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo base_url('index.php/dashboard/update/') . $row['id_barang']; ?>" class="btn btn-success" title="Update Data"><i class='fa fa-wrench'></i></a>
                                                                ...
                                                                <a href="<?php echo base_url('index.php/dashboard/delete/') . $row['id_barang']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-circle" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class='fa fa-trash'></i></a>
