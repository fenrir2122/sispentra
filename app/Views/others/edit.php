                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <?php echo form_open(base_url('index.php/dashboard/update/')); ?>
                                    <?php foreach ($query->result_array() as $key) {?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="nama_barang" name="nama_barang" required="required" class="form-control " value="<?php echo $key['nama_barang'];?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Jumlah Barang <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="jumlah" name="jumlah" required="required" class="form-control" value="<?php echo $key['jumlah'];?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Keterangan <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="keterangan" class="form-control" type="text" name="keterangan" value="<?php echo $key['keterangan'];?>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="jenis_barang" class="col-form-label col-md-3 col-sm-3 label-align">Jenis Barang </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <select name="id_tabel" class="form-control">
                                                    <?php
                                                        foreach ($tabel->result_array() as $row) { ?> <option value="<?php echo $row['id_tabel'] ?>"><?php echo $row['nama_tabel'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
