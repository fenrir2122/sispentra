                        ...
                        <div class="x_content">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="x_panel">
                                        <div class="x_content">
                                            <form method="post" action="<?php echo base_url() . 'index.php/admin/tambahPakaiKomponen'; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                                <br>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-2 col-sm-2 offset-md-3">
                                                        <a class="btn btn-success" href="<?php echo base_url('index.php/admin/insertPakaiKomponen/'); ?>">Submit</a>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($this->cart->contents() as $items) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="align-middle text-center"><a class="btn btn-sm btn-danger" href="<?php echo base_url('index.php/admin/hapusCartPakai/') . $items['rowid']; ?>">Hapus</a></td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
                                                        </table>
