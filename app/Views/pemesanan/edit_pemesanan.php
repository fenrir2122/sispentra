            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form method="post" action="<?php echo base_url() . 'index.php/admin/insertEditPemesanan'; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input name="nama" id="nama" class="form-control" required="required" type="text" value="<?php echo $pemesanan->row()->nama;?>">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input name="nik" id="nik" class="form-control" required="required" type="text" value="<?php echo $pemesanan->row()->nik;?>">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input name="tanggal_pesan" id="tanggal_pesan" class="form-control" required="required" type="date" value="<?php echo $pemesanan->row()->tanggal_pesan;?>">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <textarea name="alamat" id="alamat" class="form-control" rows="3"><?php echo $pemesanan->row()->alamat;?></textarea>
                                    </div>
                                </div>
