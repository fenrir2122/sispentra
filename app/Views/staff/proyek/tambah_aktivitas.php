            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form method="post" action="<?php echo base_url() . 'index.php/staff/tambahAktivitas/'.$id_proyek; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input name="tanggal_aktivitas" id="tanggal_aktivitas" class="form-control" required="required" type="date" value="<?php echo date("Y-m-d");?>">
                                    </div>
                                </div>
