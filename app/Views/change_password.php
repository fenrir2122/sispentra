					...
					<div class="row no-gutters">
						<div class="col-lg-12">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
										<form method="post" action="<?= base_url() . '/public/index.php/fpassword/c_change/' . $email . '/' . $password; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											<?= csrf_field(); ?>
											<div class="form-row">
												<div class="form-group col-12 mb-0">
													<div class="input-group">
														...
														<div class="input-group-append">
															<button id="pass" class="btn btn-secondary" onclick="passconvert('password')" type="button"><span class="fa fa-eye"></span></button>
														</div>
													</div>
												</div>
												...
												<div class="form-group col-12 mb-0">
													<div class="input-group">
														<input type="password" class="form-control" name="repeat" id="repeat" placeholder="Retype your password" required>
														<div class="input-group-append">
															<button id="pass" class="btn btn-secondary" onclick="passconvert('repeat')" type="button"><span class="fa fa-eye"></span></button>
														</div>
													</div>
												</div>
