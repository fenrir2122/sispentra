                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form method="post" action="<?php echo base_url() . 'index.php/admin/editPassword/' . $id_user; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
