            ...
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="x_content">
                  ...
                  <a class="btn btn-round btn-sm btn-primary my-auto" href="<?php echo base_url('public/index.php/admin/addamendment');?>"><i class="fa fa-plus fa-fw"></i> Add Amendment</a>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_panel">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <table id="example" class="table table-bordered dt-responsive table-hover dataTable" style="width:100%;">
                          <thead class="thead-dark">
                            <tr>
                              <th class="text-center">Nama Pekerjaan</th>
                              <th class="text-center">Tipe Amandemen</th>
                              <th class="text-center">Amandemen ke-</th>
                          ...
                          <tbody>
                            <?php foreach ($amandemen as $value) { ?>
                              <tr>
                                <td class="align-middle text-center"><?php echo $value['nama_pekerjaan']; ?></td>
                                <td class="align-middle text-center"><?php echo $value['tipe_amandemen']; ?></td>
                                <td class="align-middle text-center"><?php echo $value['amandemen_ke']; ?></td>
                                <td class="align-middle text-center"><?php echo $value['tgl_mulai']; ?></td>
                                <td class="align-middle text-center"><?php echo $value['tgl_selesai']; ?></td>
