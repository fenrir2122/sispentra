          ...
          <div class="col-md-12 col-sm-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <a class="btn btn-round btn-sm btn-primary float-right" href=""><i class="fa fa-plus fa-fw"></i> Add Amandment</a>
                </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_panel">
                        ...
                        <table id="example" class="table table-striped table-bordered datatable" style="width:100%;">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-middle text-center"><?php echo $value['tanggal_mulai'];?></td>
                              <td class="align-middle text-center"><?php echo $value['tanggal_selesai'];?></td>
