                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?= base_url() . '/public/index.php/drafter/adddraft'; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <?= csrf_field(); ?>
                                    <div class="container">
                                        <div class="row">
                                            <div class="item form-group align-items-center col-12">
                                                ...
                                                <div class="col-7 ">
                                                    <textarea name="judul_kontrak" id="judul_kontrak" class="form-control" rows="4"></textarea>
                                                </div>
                                            </div>
                                            <div class="item form-group align-items-center col-12">
                                                ...
                                                <div class="col-7 ">
                                                    <input name="tanggal_blangko" id="tanggal_blangko" class="form-control" required="required" type="date">
                                                </div>
                                            </div>
                                            <div class="item form-group align-items-center col-12">
                                                ...
                                                <div class="col-7 ">
                                                    <input type="text" name="nama_kontraktor" id="nama_kontraktor" required="required" class="form-control ">
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sp3mk_nomor" id="sp3mk_nomor" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input name="sp3mk_tanggal" id="sp3mk_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group mb-1">
                                                                                    ...
                                                                                    <input type="text" name="sp3mk_harga_kontrak" id="sp3mk_harga_kontrak" required="required" class="form-control" data-type="currency" aria-describedby="basic-addonrp">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="sp3mk_mpp" class="form-control col-8">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sp3mk_jaminan_pelaksanaan" id="sp3mk_jaminan_pelaksanaan" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="sp3mk_masa_berlaku" class="form-control col-8" required="required">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input name="sp3mk_tanggal_mulai" class="form-control col-5" required="required" type="date">
                                                                                    <div class="col-2">
                                                                                        <h2 class="text-center mt-2">-</h2>
                                                                                    </div>
                                                                                    <input name="sp3mk_sampai_dengan" class="form-control col-5" required="required" type="date">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="spppj_nomor" id="spppj_nomor" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align">Tanggal<span class="required">*</span>
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input name="spppj_tanggal" id="spppj_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="spppj_coll_no" id="spppj_coll_no" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group mb-1">
                                                                                    ...
                                                                                    <input type="text" name="spppj_harga_kontrak" id="spppj_harga_kontrak" required="required" class="form-control" data-type="currency" aria-describedby="basic-addonrp">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="spppj_jangka_pelaksanaan" id="spppj_jangka_pelaksanaan" class="form-control ">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="spppj_masa_berlaku" class="form-control col-8" required="required">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="container">
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align" for="first-name">Revisi No.<span class="required">*</span>
                                                                            </label>
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="rks_revisi" id="rks_revisi" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align">Keterangan<span class="required">*</span>
                                                                            </label>
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="rks_keterangan" id="rks_keterangan" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="rks_mpp" id="rks_mpp" class="form-control ">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="rks_masa_pemeliharaan" id="rks_masa_pemeliharaan" class="form-control ">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="rks_masa_garansi" id="rks_masa_garansi" class="form-control ">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group mb-1">
                                                                                    <input type="text" name="rks_denda" id="rks_denda" class="form-control" aria-describedby="basic-addon%">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <textarea name="rks_mekanisme_pembayaran" id="rks_mekanisme_pembayaran" placehoder="Apabila terlalu panjang agar dituliskan nomor halaman pada RKS." class="form-control" rows="4"></textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="rks_jenis_kontrak" id="rks_jenis_kontrak" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group mb-1">
                                                                                    <input type="text" name="rks_besar_jaminan" id="rks_besar_jaminan" class="form-control" aria-describedby="basic-addon%">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-text">%</span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="rks_direksi_pekerjaan" id="rks_direksi_pekerjaan" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="rks_mpa" id="rks_mpa" class="form-control ">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sphn_nomor" id="sphn_nomor" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sphn_perihal" id="sphn_perihal" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input name="sphn_tanggal" id="sphn_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-6 col-9 ">
                                                                                <input name="snh_tanggal" id="snh_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sph_nomor" id="sph_nomor" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align">Perihal<span class="required">*</span>
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="sph_perihal" id="sph_perihal" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input name="sph_tanggal" id="sph_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12 col-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="prebid_coll_no" id="prebid_coll_no" required="required" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align">Tanggal<span class="required">*</span>
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input name="prebid_tanggal" id="prebid_tanggal" class="form-control" required="required" type="date">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
                                                                            <label class="col-form-label col-md-3 col-sm-3 col-3 label-align" for="first-name">Masa Penyelesaian Pekerjaan<span class="required">*</span>
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="prebid_mpp" class="form-control col-8" required="required">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="prebid_masa_pemeliharaan" class="form-control col-8" required="required">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="prebid_masa_garansi" class="form-control col-8" required="required">
                                                                        ...
                                                                        <div class="item form-group align-items-center">
                                                                            ...
                                                                            <div class="col-md-9 col-sm-9 ">
                                                                                <input type="text" name="prebid_jaminan_pelaksanaan" id="prebid_jaminan_pelaksanaan" class="form-control ">
                                                                            </div>
                                                                        </div>
                                                                        <div class="item form-group align-items-center">
